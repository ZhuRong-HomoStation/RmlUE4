...
class FUERmlFontInterface : public Rml::FontEngineInterface
{
public:
	// virtual ~FUERmlFontInterface() override;

protected:
	// ~Begin FontEngineInterface API 
	...
	// virtual int GetStringWidth(Rml::FontFaceHandle handle, const Rml::String& string, Rml::Character prior_character) override;
